...
import {resetMachine,setAxisAndWheel,turnControl,safetyStatus,toggleDemoWorkpiece,indexTool,emergencyStop,releaseEmergency,setDetent} from '../machines/runtime';
export default function useMachineControls(model) {
 ...
 return {model,running,direction,rpm,resetKey,teaching,interaction,setInteraction,held,release,invalidate,version,refresh,stopInput,
