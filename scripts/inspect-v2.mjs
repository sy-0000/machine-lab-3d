...
await page.goto('http://localhost:5173/scripts/inspect.html?model=deliver_milling_machine_split/milling_machine_split.glb');await page.waitForFunction(()=>window.ready);
for(const [file,names,eye,isolate]of [
