...
export default function LevelsPage() {
  return <main className="info-page levels-page">
    <div className="info-header"><a className="back-link" href="#/">← 返回首頁</a><span className="eyebrow green">加工挑戰</span><h1>加工關卡</h1>
      <p className="subtitle">三台機台各一關，每關 5 分鐘。車到指定尺寸後繳交，依誤差得到 1–3 顆星。</p></div>
    <ol className="challenge-cards">
      {CHALLENGES.map((c, i) => <li key={c.id} className="challenge-card">
        ...
        <div className="challenge-card-body">
          <small>{MACHINE[c.machine]} · 5 分鐘</small>
    ...
    <div className="level-howto"><h2>每一關怎麼玩</h2><ol><li><b>任務</b>看目標尺寸與步驟</li><li><b>實作</b>5 分鐘，自己操作機台</li><li><b>繳交</b>停主軸後繳交</li><li><b>星數</b>依尺寸誤差給 1–3 顆星</li></ol></div>
  </main>;
}
